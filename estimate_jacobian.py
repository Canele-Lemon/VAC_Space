...
def build_white_X_Y0(pk_list, set_mapping):
    ...
    - X : (N, 11) feature (ΔR_H, ΔG_H, ΔB_H, panel_onehot, frame_rate, (model_year), gray_norm, LUT_j)
    ...
    idx_gray = 3 + K + 1  # [ΔR,ΔG,ΔB]=3 + panel(K) + frame_rate
...
def estimate_jacobians_per_gray(
    ...
    """
    X, Y0, groups, idx_gray, ds = build_white_X_Y0(pk_list, set_mapping)
...
def debug_print_XY_at_grays(
    ...
    """
    X, Y0, groups, idx_gray, ds = build_white_X_Y0(pk_list=pk_list, set_mapping=set_mapping,)
...
def main():
    ...
    # ========================================================================================= #        
    lam = 1e-3 # 리지 정규화 계수
    delta_window = None # delta-window    
    gauss_sigma = None
    min_samples = 3
    # ========================================================================================= #

# batch_build_287_luts.py
# - 기존 build_lut_from_knots_offsets.py 기반
# - R/G/B 오프셋 조합 7가지 × (-100~100 step5) = 287개 LUT 생성
...
# 기본 설정
# ───────────────────────
LOW_LUT_CSV    = r"./your_low_lut_4096.csv"
HIGH_KNOT_CSV  = r"./your_high_knots_34.csv"
OUTPUT_DIR     = r"./LUT_Batch_287"

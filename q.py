...
Traceback (most recent call last):
  File "d:\00 업무\00 가상화기술\00 색시야각 보상 최적화\VAC algorithm\VAC_Optimization_Project\src\data_preparation\prepare_input.py", line 370, in <module>
    builder.debug_dump_delta_with_mapping(pk=2757, ref_vac_info_pk=2744)
TypeError: VACInputBuilder.debug_dump_delta_with_mapping() got an unexpected keyword argument 'ref_vac_info_pk'
이런 에러가 발생해요

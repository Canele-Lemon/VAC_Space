...
def build_white_X_Y3(pk_list, ref_pk):
    ...
    core_mask = (gray_idx >= 2) & (gray_idx <= 253) & finite_mask
...
Traceback (most recent call last):
  File "d:\00 업무\00 가상화기술\00 색시야각 보상 최적화\VAC algorithm\module\scripts\estimate_jacobian.py", line 190, in <module>
    X, Y3, g_cx, idx_gray, ds = build_white_X_Y3(pk_list=[2635], ref_pk=2582)
  File "d:\00 업무\00 가상화기술\00 색시야각 보상 최적화\VAC algorithm\module\scripts\estimate_jacobian.py", line 32, in build_white_X_Y3
    raise RuntimeError("X 행렬 형태가 일치하지 않습니다 (dCx/dCy/dGamma).")
